                        ...
                        setTimeout( function(){
                            ...
                            setTimeout( function(){
                               if( !slidein.hasClass('do_not_close')){
                                    if( slidein.data('form-action') == "disappear" ){
                                        slidein.removeClass("si-open");
                                    } else {
                                        cp_animate.removeClass(exit_anim);
                                    }
...
jQuery(window).on("cp_custom_analytics", function(e,style_id) {
    setTimeout(function() {
        ...
        data = {action:'custom_form_update_conversions',conversion:true,style_id:style_id,option:'smile_modal_styles',security:nounce};
        jQuery.ajax({
            url:smile_ajax.url,
            data: data,
            type: "POST",
