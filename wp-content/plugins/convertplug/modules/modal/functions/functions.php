...
if ( ! function_exists( 'cp_generate_style_css' ) ) {
	...
	function cp_generate_style_css( $a ) {
		...
		// Append CSS code.
		echo '<style type="text/css">' . '</style>'; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
...
if ( ! function_exists( 'cp_modal_global_after_init' ) ) {
	...
	<div class="cp-overlay-close <?php echo esc_attr( $close_class ) . ' ' . esc_attr( $close_overlay_class ); ?>" style="width: <?php echo esc_attr( $cp_close_image_width ); ?>">
        <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.974823 17.0609L17.9748 0.060945L19.389 1.47516L2.38904 18.4752L0.974823 17.0609Z" fill="black"/>
            <path fill-rule="evenodd" clip-rule="evenodd" d="M2.97486 0.0609298L19.5208 16.6927L18.1029 18.1032L1.557 1.47148L2.97486 0.0609298Z" fill="black"/>
        </svg>
