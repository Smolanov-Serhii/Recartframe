...
function qtranxf_generateLanguageSelectCode( $args = array(), $id = '' ) {
    ...
    echo '<div class="language">';
                foreach ( qtranxf_getSortedLanguages() as $language ) {
                    if ( $language == $q_config['language'] ) {
                        echo '<span class="lang__holder"><span';
                        echo '>' . $q_config['language_name'][ $language ] . '</span></span>';
                    }
                }

    echo '<div class="hidden__lang">';
    ...
    echo '</ul><div class="qtranxs_widget_end"></div></div></div>' . PHP_EOL;
}
